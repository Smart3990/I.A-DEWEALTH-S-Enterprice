...
export function ProductEditorModal({
  ...
  const [specCondition, setSpecCondition] = useState("Brand New");
  const [specSeller, setSpecSeller] = useState("IA Dewealth Official Store");
  const [specWarranty, setSpecWarranty] = useState("12 Months Official Warranty");
  const [specDelivery, setSpecDelivery] = useState("Same-day Accra dispatch, 24-48h nationwide");
  ...
  useEffect(() => {
    ...
    if (product) {
      ...
      setStock(product.stock != null ? Number(product.stock) : 10);
      setBadge(product.badge || product.tag || "");
      setRating(product.rating != null ? Number(product.rating) : 4.8);
      setReviewsCount(
      ...
      setOriginalPrice("");
      setStock(15);
      setBadge("Accra Same-Day Dispatch");
      setRating(4.9);
      setReviewsCount(12);
      ...
      setSpecBrand("");
      setSpecCondition("Brand New");
      setSpecSeller("IA Dewealth Official Store");
      setSpecWarranty("12 Months Official Warranty");
      setSpecDelivery("Same-day Accra dispatch, 24-48h nationwide");
    }
    setErrorMsg("");
  ...
  const discountPercent = useMemo(() => {
    if (typeof originalPrice === "number" && originalPrice > price && originalPrice > 0) {
  ...
  async function handleSave() {
    ...
    try {
      ...
      const row = {
        ...
        price: Number(price),
        was_price: typeof originalPrice === "number" ? originalPrice : Number(price),
        stock: Number(stock),
        ...
        condition: specCondition || "Brand New",
        is_active: isActive,
        is_deal: isSuperDeal,
      ...
      await logActivity(
        isNew ? `Created new product: ${title}` : `Updated product card: ${title} (${id})`,
      );
  ...
  function handleAddGalleryImage() {
    ...
    setImages((prev) => [...prev, newGalleryUrl.trim()]);
    setNewGalleryUrl("");
  }
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g. p-smartphone-1"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="mt-1.5 w-full rounded-xl border border-slate-200 bg-white px-3.5 py-2 text-xs font-bold text-slate-800 focus:border-[#00a884] focus:outline-hidden"
                    >
                      {categories.map((c) => (
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      className="mt-1.5 w-full rounded-xl border border-slate-200 px-3.5 py-2 text-xs font-mono text-slate-800"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="mt-1.5 w-full rounded-xl border border-slate-200 bg-white px-3.5 py-2 text-xs font-bold text-slate-800"
                    >
              ...
              <div className="space-y-5">
                ...
                <div>
                  <span className="text-xs font-bold text-slate-700">
                    Quick Preset Assets (One-Click Selection)
                  </span>
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-400">
                    These appear in the product page thumbnail gallery.
                  </p>
                  ...
                  <div className="mt-2 flex gap-2">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1 rounded-xl bg-slate-900 px-3.5 py-2 text-xs font-bold text-white hover:bg-slate-800"
                    >
                      ...
                      {images.map((imgUrl, i) => (
                        ...
                        >
                          ...
                          <button
                            ...
                            className="absolute right-1.5 top-1.5 rounded-lg bg-red-600/90 p-1 text-white opacity-0 group-hover:opacity-100 transition"
                          >
