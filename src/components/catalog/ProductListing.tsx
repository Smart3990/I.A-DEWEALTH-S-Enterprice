...
const sorts = {
  recommended: {
    label: "Recommended",
    fn: (a: CatalogProduct, b: CatalogProduct) => {
      // Prioritize new arrivals and recently added items
      ...
      return b.rating * (b.sold || 1) - a.rating * (a.sold || 1);
    },
  },
  newest: {
    label: "Newest",
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[260px_1fr]">
      ...
      <div>
        ...
        {shown.length ? (
          <>
            <div className="grid grid-cols-2 gap-2.5 sm:gap-5 sm:grid-cols-2 xl:grid-cols-3">
              {shown.map((p) => (
