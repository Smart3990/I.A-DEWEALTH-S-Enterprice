...
export function ShopMenu() {
  ...
  const getNonEmptyChildren = (parentId: string | null) => {
    return childrenOf(parentId).filter((cat) => {
  ...
  return (
    <div className="hidden lg:block relative bg-nav text-nav-foreground">
      <div className="mx-auto max-w-container-max px-4 lg:px-6">
        ...
        >
          ...
          <div className="hidden flex-wrap items-center justify-center gap-1 lg:flex">
            {roots.map((root) => {
              const groups = getNonEmptyChildren(root.id);
                ...
                >
                  ...
                  {isOpen && groups.length > 0 && (
                    ...
                    >
                      ...
                      >
                        {groups.map((group) => {
                          const kids = getNonEmptyChildren(group.id);
                          return (
