...
import productsCatalogJson from "./products-catalog.json";

export const initialCatalogProducts: CatalogProduct[] =
  productsCatalogJson as unknown as CatalogProduct[];
...
export const collections: Collection[] = [
  ...
  },
  {
    ...
    icon: "Sparkles",
    select: (all) => {
      // Newly added or flagged arrivals appear first, replacing older products
      const flagged = all.filter((p) => Boolean(p.newArrival));
