            ...
            {filteredCategories.map((cat) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="relative h-36 w-full overflow-hidden bg-slate-100 flex items-center">
                    <img
                      src={cat.bannerImage}
                      alt={cat.name}
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-xs overflow-y-auto">
      <div className="relative w-full max-w-lg rounded-2xl bg-white shadow-2xl overflow-hidden my-8 p-6 space-y-4">
        ...
        {/* Live Card Preview */}
        <div className="relative h-28 w-full overflow-hidden rounded-xl bg-slate-100 flex items-center shadow-xs">
          <img
