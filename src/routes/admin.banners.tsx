        ...
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
          {filteredBanners.map((banner) => (
            ...
            >
              ...
              <div className="relative min-h-[220px] w-full overflow-hidden bg-slate-100 flex items-center">
      ...
      <div className="relative w-full max-w-4xl rounded-2xl bg-white shadow-2xl overflow-hidden my-8 max-h-[90vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="relative min-h-[220px] w-full overflow-hidden rounded-2xl bg-slate-100 flex items-center shadow-md">
              <img
                src={form.image}
